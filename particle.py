...
class Particle(pygame.sprite.Sprite):
    def __init__(self, x, y, color):
        ...
        self.lifetime = 1.0  # Starts at 10, decreases to 0
    ...
    def draw(self, screen):
        ...
        for angle in range(0, 360, 60):
            ...
            pygame.draw.line(screen, self.color, (branch_start_x, branch_start_y), (branch1_x, branch1_y))
            pygame.draw.line(screen, self.color, (branch_start_x, branch_start_y), (branch2_x, branch2_y))